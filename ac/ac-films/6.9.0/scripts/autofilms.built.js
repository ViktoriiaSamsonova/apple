!function() {
    ...
    , {
        ...
        "@marcom/ac-dom-traversal/matchesSelector": 61,
    ...
    , {
        "@marcom/ac-dom-nodes/COMMENT_NODE": 48,
        "@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE": 49,
        "@marcom/ac-dom-nodes/DOCUMENT_NODE": 50,
        "@marcom/ac-dom-nodes/ELEMENT_NODE": 51,
        "@marcom/ac-dom-nodes/TEXT_NODE": 52,
    ...
    , {
        "./internal/nativeMatches": 59,
        "./internal/validate": 60,
    ...
    , {
        "./ac-event-emitter-micro/EventEmitterMicro": 66
    }],
    66: [function(e, t, i) {
        "use strict";
        function n() {
    ...
    , {
        "./ac-event-emitter/EventEmitter": 68
    }],
    68: [function(e, t, i) {
        "use strict";
        var n = e("@babel/runtime/helpers/interopRequireDefault")(e("@babel/runtime/helpers/typeof"))
        ...
        var d = e("@marcom/ac-event-emitter-micro/EventEmitterMicro")
          ...
          , _ = function(e) {
            ...
            function i(e) {
                ...
                return (0,
                r.default)(this, i),
                (n = t.call(this))._keysDown = {},
                n._DOMKeyDown = n._DOMKeyDown.bind((0,
                s.default)(n)),
                n._DOMKeyUp = n._DOMKeyUp.bind((0,
                s.default)(n)),
                n._context = e || document,
                n._context.addEventListener(f, n._DOMKeyDown, !0),
                n._context.addEventListener(m, n._DOMKeyUp, !0),
                n
            }
            return (0,
            o.default)(i, [{
                ...
                value: function() {
                    ...
                    (0,
                    a.default)((0,
                    u.default)(i.prototype), "destroy", this).call(this),
                    this
                }
            }, {
                key: "_DOMKeyDown",
    ...
    , {
        ...
        "@marcom/ac-event-emitter-micro/EventEmitterMicro": 66
    }],
    70: [function(e, t, i) {
        "use strict";
        var n = e("./Keyboard");
    ...
    75: [function(e, t, i) {
        ...
        var v = ["beforeCreate", "created", "beforeMount", "mounted", "onWillOpen", "onOpen", "onWillClose", "onClose", "onResizeImmediate", "onBreakpointChange", "onResizeDebounced", "destroy"]
          ...
          , y = function(e) {
            ...
            var t = _(i);
            function i(e) {
                var n, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : b;
                return (0,
                r.default)(this, i),
                (n = t.call(this, o)).elements = {},
                n.elements.content = e,
                n.options = o,
                n.opened = !1,
                n.model = Object.assign({}, JSON.parse(JSON.stringify(d.default))),
                n.templates = {},
                v.forEach(function(e) {
                    n[e] = function() {
                        for (var t = arguments.length, i = new Array(t), r = 0; r < t; r++)
                            i[r] = arguments[r];
                        n["__".concat(e)] && n["__".concat(e)].forEach(function(e) {
                            return e.apply((0,
                            s.default)(n), i)
                        })
                    }
            ...
            o.default)(i, [{
                ...
                value: function() {
                    for (var e = function(e) {
                        ...
                        return (0,
                        o.default)(i)
                    }(i), t = e.prototype, n = arguments.length, s = new Array(n), l = 0; l < n; l++)
                        s[l] = arguments[l];
                    return [p.default].concat(s, [m.default, f.default]).forEach(function(e) {
                        for (var i in e)
                            v.includes(i) ? (t["__".concat(i)] = t["__".concat(i)] || [],
                            t["__".concat(i)].push(e[i])) : t[i] = e[i]
                    }),
                    e
                }
            }]),
    ...
    , {
        ...
        "@babel/runtime/helpers/interopRequireDefault": 10,
        "@babel/runtime/helpers/possibleConstructorReturn": 13,
        "@marcom/ac-dom-nodes/isNode": 74,
        "@marcom/ac-event-emitter-micro/src/ac-event-emitter-micro/EventEmitterMicro": 66
    }],
    76: [function(e, t, i) {
        "use strict";
        var n = e("@babel/runtime/helpers/interopRequireDefault");
        ...
        var d = [{
          ...
          , m = function(e) {
            ...
            function i() {
                ...
                return (0,
                r.default)(this, i),
                (e = t.call(this)).BREAKPOINTS = n.breakpoints || d,
                e._setupProperties(),
            ...
            o.default)(i, [{
                ...
                value: function() {
                    ...
                    (0,
                    a.default)((0,
                    u.default)(i.prototype), "on", this).apply(this, arguments)
                }
            }, {
                key: "_onRetinaChange",
                value: function() {
                    this.trigger(i.CHANGE_EVENTS.RETINA, this)
                }
            }, {
                key: "_onOrientationChange",
                value: function() {
                    this.trigger(i.CHANGE_EVENTS.ORIENTATION, this)
                }
            }, {
                ...
                value: function(e) {
                    var t = this;
                    if (e !== i.CHANGE_EVENTS.RETINA || this.listenersAdded.retina || (window.matchMedia(p).addListener(this._onRetinaChange),
                    this.listenersAdded.retina = !0),
                    e !== i.CHANGE_EVENTS.ORIENTATION || this.listenersAdded.orientation || (window.matchMedia(f).addListener(this._onOrientationChange),
                    this.listenersAdded.orientation = !0),
                    e === i.CHANGE_EVENTS.VIEWPORT && !this.listenersAdded.viewport) {
                        for (var n = function() {
                            var e = t.BREAKPOINTS[r];
                            window.matchMedia(e.mediaQuery).addListener(function(n) {
                                n.matches && (t.oldViewport = t.viewport,
                                t.viewport = e.name,
                                t.trigger(i.CHANGE_EVENTS.VIEWPORT, t))
                            })
    ...
    , {
        ...
        "@babel/runtime/helpers/interopRequireDefault": 10,
        "@babel/runtime/helpers/possibleConstructorReturn": 13,
        "@marcom/ac-event-emitter-micro": 65
    }],
    134: [function(e, t, i) {
        ...
        var p = e("@marcom/ac-raf-emitter/update")
          ...
          , N = function(e) {
            ...
            function i(e) {
                ...
                (0,
                s.default)(this, i),
                (n = t.call(this)).el = e.el,
                x || setTimeout(function() {
                    n.trigger("error")
                }),
                n._textureSrc = e.src,
                e.video ? n._videoElement = e.video : e.src instanceof HTMLVideoElement ? n._videoElement = e.src : n._textureSrc && (n._textureSrc.endsWith(".mp4") || n._textureSrc.endsWith(".m3u8") || n._textureSrc.endsWith(".webm")) && (n._videoElement = document.createElement("video")),
                n._flat = e.flat,
                n._maxLat = e.maxLat || S,
                n._pointerControls = new m({
                    el: e.mouseTarget || n.el
                }),
                n.arrowControls = new w,
                n._easing = e.easing || P,
                n._sineEasing = e.sineEasing || L,
                n._mapMinValue = void 0 !== e.mapMinValue ? e.mapMinValue : D,
                n._mapMaxValue = e.mapMaxValue || R,
                n._rotationDuration = e.rotationDuration || M,
                T && (n._orientationControls = new _),
                n._panVelocity = Object.assign({}, e.panVelocity || A),
                n._overshootMultiplier = e.overshootMultiplier || O,
                n._oscillationDuration = e.ocillationDuration || I,
                n._oscillationDistance = e.ocillationDistance || F,
                n._bindMethods();
                var r = window.THREE ? Promise.resolve() : C(e.threeUrl || j);
                return n._cachedPos = {
                    lat: 0,
                    lon: 0
                },
            ...
            a.default)(i, [{
                ...
                value: function(e) {
                    if (window.THREE) {
                        var t = e;
                        t || (t = this.arrowControls.isActive ? this.arrowControls.position : this._pointerControls.isActive ? this._pointerControls.position : this._orientationControls ? this._orientationControls.position : this._cachedPos);
                        var n = !1;
                        if (this._cachedPos.lat !== t.lat || this._cachedPos.lon !== t.lon)
                            n = !0;
                        else if (this._videoElement && this._videoElement.paused)
                            return;
                        var r = this._renderer.update(t);
                        ...
                        n && this.trigger(i.POSITION_CHANGE)
                    }
                }
            }, {
                key: "refreshSize",
                ...
                value: function() {
                    (0,
                    l.default)((0,
                    h.default)(i.prototype), "destroy", this).call(this)
                }
            }, {
                key: "position",
                get: function() {
                ...
                value: function() {
                    ...
                    var t = new THREE.Vector2(this.position.lon,this.position.lat)
                    ...
                    this.trigger(i.ROTATION_START, r),
                    new Promise(function(o) {
                        e._currentTimer = g(n, function(n) {
                            var o = Math.sin(Math.PI * e._sineEasing.getValue(n))
                              , s = (new THREE.Vector2).copy(t);
                            s.x = t.x - o * e._oscillationDistance,
                            e._tmpCurrentPosition = {
                                lat: s.y,
                                lon: s.x
                            },
                            e.trigger(i.ROTATION_UPDATE, {
                                t: n,
                                easedVal: o,
                        ...
                        e._currentTimer.promise.then(function() {
                            e.trigger(i.ROTATION_COMPLETE, r),
                            e.setPos(t.y, t.x),
                            e._animate(),
                            e._currentTimer = null,
                ...
                value: function(e, t) {
                    ...
                    if (this._currentTimer)
                        return this._currentTimer.cancel().then(function() {
                            ...
                            n._respositionCameraToPosition(e, t)
                        });
                    if (this._pointerControls.cancelInertia(),
                    this.arrowControls.cancelInertia(),
                    e.lat === this.position.lat && e.lon === this.position.lon)
                        return this.trigger(i.ROTATION_START, {
                            time: 0,
                            startPosition: Object.assign({}, this.position),
                            targetPosition: Object.assign({}, this.position)
                        }),
                        this.trigger(i.ROTATION_COMPLETE, {
                            time: 1,
                            startPosition: Object.assign({}, this.position),
                            targetPosition: Object.assign({}, this.position)
                        }),
                        Promise.resolve();
                    t = t ? b(t.x1, t.y1, t.x2, t.y2) : this._easing;
                    ...
                    return this.trigger(i.ROTATION_START, h),
                    new Promise(function(t) {
                        n._currentTimer = g(u, function(e) {
                            var t;
                            t = 1 === e ? 1 : k(n._easing.getValue(e), 0, 1, n._mapMinValue, n._mapMaxValue);
                            var o = c.lerpVectors(r, s, t);
                            n.trigger(i.ROTATION_UPDATE, {
                                t: e,
                                easedVal: t,
                        ...
                        n._currentTimer.promise.then(function() {
                            n.trigger(i.ROTATION_COMPLETE, h),
          ...
          , _ = function(e) {
            ...
            o.default)(i, [{
                ...
                value: function() {
                    ...
                    (0,
                    s.default)((0,
                    c.default)(i.prototype), "_bindMethods", this).call(this)
                }
            }, {
                key: "leftArrowDown",
                value: function() {
        ...
        var h = e("../utils/normalizeLongitude")
          ...
          , p = function(e) {
            ...
            function i(e) {
                ...
                r.default)(this, i),
                e = Object.assign({}, d, e),
                (n = t.call(this, e)).el = e.el,
                n._mouseDown = !1,
                n._scale = 1,
                n._hasInertia = !1 !== e.inertia || e.inertia,
                n._bindMethods(),
    ...
    336: [function(e, t, i) {
        ...
        var a = e("../ui/localization/LanguageMapping")
          ...
          , R = e("../ui/keyboard-control/createKeyboardControl")
          , M = e("../ui/controls-interaction/createControlsInteraction")
            ...
            r(t, [{
                ...
                value: function() {
                    if (!this._player.getEnded() && !isNaN(this._getDuration()) && 0 !== this._getDuration()) {
                        ...
                        this._setPlayerCurrentTime(e * this._getDuration()),
    ...
    424: [function(e, t, i) {
        ...
        var s = window.Hls
          ...
          , c = "/ac/libs/hls.js/2.450.3/hls.js"
