!function e(t, n, r) {
    ...
    2: [function(e, t, n) {
        ...
        h._setTabbingByIndex = function(e) {
            ...
            s(t.getAttribute(this._state)) && (this.focusedNavItemIndex = e,
            this.selectedNavitemIndex = e),
            s(t.getAttribute(l.DISABLED)) ? r(t) : i(t)
        }
        ,
        h.start = function() {
        ...
        h._toggleState = function() {
            ...
            s(e) ? this._navItems[this.focusedNavItemIndex].setAttribute(this._state, "false") : this._navItems[this.focusedNavItemIndex].setAttribute(this._state, "true")
        }
        ,
        h._calculateIndex = function(e, t) {
            ...
            if (!0 === e) {
                ...
                !s(this._navItems[n].getAttribute(l.DISABLED)) || this._navItems[n].hasAttribute("disabled"))
                    return n
        ...
        h.addNavItem = function(e) {
            e && e.nodeType && this._navItems.indexOf(e) < 0 && (s(e.getAttribute(l.DISABLED)) || i(e),
    ...
    71: [function(e, t, n) {
        ...
        function o() {
            var e, t = /\{%([^%]+)%\}/g, n = Array.prototype.slice.call(arguments), r = n.pop(), o = r.fn ? r.fn(this) : s(n[0]);
            if (r.fn)
                e = n[0] || this;
            else {
                e = n[1] || this;
            ...
            return o ? o.replace(t, (function(n, o) {
                var l, c = o.replace(t, "$1").trim();
                return "@root." === c.substr(0, 6) && (l = i.get(r.data.root, c.substr(6))),
                s(l || i.get(r.hash || {}, c) || a && i.get(a || {}, c) || i.get(e || {}, c) || i.get(r.data.root || {}, c) || "")
            }
            )) : ""
        }
        t.exports = function(e) {
        ...
        !function() {
            ...
            try {
                ...
                Array.prototype.slice = function(t, n) {
                    ...
                    var r, i, s = [], o = this.length, a = t || 0, l = n || o;
                    if (n < 0 && (l = o + n),
                    (i = l - (a = a >= 0 ? a : o + a)) > 0)
                        if (s = new Array(i),
                        this.charAt)
        ...
        t.exports = function e(t, n) {
            ...
            for (u = 0; u < o.evt.length; u++)
                ...
                r(l, n))
                    return o.reduce(u),
                    c[t] = l;
            return "window" !== n && s.indexOf(t) ? c[t] = e(t, "window") : c[t] = !1
        }
    }
    , {
        101: 101,
    ...
    94: [function(e, t, n) {
        ...
        t.exports = function(e) {
            ...
            if ((e += "")in r)
                return r[e].dom;
            for (s = i(),
            n = (e = o(e)).charAt(0).toUpperCase() + e.substring(1),
    ...
    109: [function(e, t, n) {
        ...
        var a = {
            ...
            setItem: function(e, t, n) {
                return !1 === n ? o.setItem(e, t) : s.setItem(e, t),
                !0
            },
            ...
            compress: function(e) {
                ...
                for (var i in n)
                    if (e.hasOwnProperty(i) && e[i])
                        if ("expirationDate" === i) {
                            var s = this.millisecondsToOffsetDays(e[i]);
                            t[n[i]] = s
                        } else
                            t[n[i]] = e[i];
                return t
            ...
            decompress: function(e) {
                ...
                for (var i in n)
                    if (e.hasOwnProperty(n[i]))
                        if ("expirationDate" === i) {
                            var s = this.offsetDaysToMilliseconds(e[n[i]]);
                            t[i] = s
                        } else
                            t[i] = e[n[i]];
                return t
        ...
        t.exports = function(e, t) {
            ...
            if (e) {
                ...
                r.forEach((function(t, r) {
                    var s = e[t]
                      , o = (t = t.trim()) + (s = null === (s = s && "string" == typeof s ? s.trim() : s) ? "" : "=" + s) + (r === i ? "" : "&");
                    n = n ? n.concat(o) : o
                }
                ))
            }
    ...
    121: [function(e, t, n) {
        ...
        t.exports = function(e) {
            var t = {};
            return t.browser = o(i.browser, r.browser, e),
            t.os = o(i.os, r.os, e),
            t
        }
    }
    ...
    123: [function(e, t, n) {
        ...
        var r = function(e, t, n, r) {
            ...
            for (var i = t.length - 1, s = 0; s < i; s += 1) {
                if (void 0 !== n && void 0 === e[t[s]])
                    e[t[s]] = {};
                else if (!e.hasOwnProperty(t[s]) || void 0 === e[t[s]])
                    return;
                e = e[t[s]]
            }
            if (void 0 !== n) {
    ...
    130: [function(e, t, n) {
        ...
        l.prototype = {
            ...
            compile: function(e, t) {
                ...
                t.knownHelpers = s.extend(Object.create(null), {
                    helperMissing: !0,
            ...
            helperSexpr: function(e, t, n) {
                ...
                if (this.options.knownHelpers[a])
                    ...
                    s.falsy = !0,
                    this.accept(s),
                    this.opcode("invokeHelper", r.length, s.original, o.default.helpers.simpleId(s))
                }
            },
            ...
            pushParam: function(e) {
                ...
                if (this.stringParams)
                    ...
                    if (this.trackIds) {
                        var n = void 0;
                        if (!e.parts || o.default.helpers.scopedId(e) || e.depth || (n = this.blockParamIndex(e.parts[0])),
                        n) {
    ...
    131: [function(e, t, n) {
        ...
        n.preparePath = function(e, t, n) {
            n = this.locInfo(n);
            for (var r = e ? "@" : "", i = [], o = 0, a = 0, l = t.length; a < l; a++) {
                var c = t[a].part
                  , u = t[a].original !== c;
        ...
        ,
        n.prepareMustache = function(e, t, n, r, i, s) {
        ...
        ;
        var r, i = e(139), s = (r = i) && r.__esModule ? r : {
            default: r
        };
        function o(e, t) {
    ...
    132: [function(e, t, n) {
        ...
        c.prototype = {
            ...
            resolvePath: function(e, t, n, r, i) {
                ...
                if (this.options.strict || this.options.assumeObjects)
                    this.push(function(e, t, n, r) {
                        ...
                        return e ? [t.aliasable("container.strict"), "(", i, ", ", t.quotedString(n[s]), ", ", JSON.stringify(t.source.currentLocation), " )"] : i
            ...
            invokeHelper: function(e, t, n) {
                ...
                n && s.push(i.name),
                s.push(r),
                this.options.strict || s.push(this.aliasable("container.hooks.helperMissing"));
                ...
                parse: function(e) {
                    ...
                    for (var p, d, f, g, m, v, _, y, b, x, w = {}; ; ) {
                        ...
                        case 2:
                            ...
                            void 0 !== (m = this.performAction.call(w, o, l, a, this.yy, g[1], r, i)))
                                return m;
                            _ && (n = n.slice(0, -1 * _ * 2),
                            r = r.slice(0, -1 * _),
                            i = i.slice(0, -1 * _)),
              ...
              , t = function() {
                var e = {
                    ...
                    next: function() {
                        ...
                        this.match = "");
                        for (var s = this._currentRules(), o = 0; o < s.length && (!(n = this._input.match(this.rules[s[o]])) || t && !(n[0].length > t[0].length) || (t = n,
                        r = o,
                        this.options.flex)); o++)
                            ;
    ...
    134: [function(e, t, n) {
        ...
        ,
        n.PrintVisitor = o;
        var r, i = e(135), s = (r = i) && r.__esModule ? r : {
            default: r
        };
        function o() {
            this.padding = 0
            ...
            acceptKey: function(e, t) {
                ...
                if (this.mutating) {
                    if (n && !o.prototype[n.type])
                        throw new s.default('Unexpected node type "' + n.type + '" found when accepting ' + t + " on " + e.type);
                    e[t] = n
                }
            },
        ...
        o.prototype.Program = function(e) {
            ...
            for (var r = e.body, i = 0, s = r.length; i < s; i++) {
                ...
                if (h) {
                    ...
                    h.open && u(r, i, !0),
                    t && m && (c(r, i),
                    u(r, i) && "PartialStatement" === o.type && (o.indent = /([ \t]+$)/.exec(r[i - 1].original)[1])),
                    t && f && (c((o.program || o.inverse).body),
                    u(r, i)),
                    t && g && (c(r, i),
                    u((o.inverse || o.program).body))
                }
            }
            return e
        }
    ...
    137: [function(e, t, n) {
        ...
        ;
        var r, i = e(138), s = (r = i) && r.__esModule ? r : {
            default: r
        }
    }
    , {
    ...
    142: [function(e, t, n) {
        (function(r) {
            (function() {
                "use strict";
                n.__esModule = !0;
                var i, s = e(155), o = e(139), a = (i = o) && i.__esModule ? i : {
                    default: i
                };
                n.default = function(e) {
                    e.registerHelper("each", (function(e, t) {
                        ...
                        var n, i = t.fn, o = t.inverse, l = 0, c = "", u = void 0, h = void 0;
                        function p(t, n, r) {
                            u && (u.key = t,
                            u.index = n,
                            u.first = 0 === n,
    ...
    144: [function(e, t, n) {
        "use strict";
        n.__esModule = !0;
        var r, i = e(155), s = e(139), o = (r = s) && r.__esModule ? r : {
            default: r
        };
        n.default = function(e) {
    ...
    153: [function(e, t, n) {
        ...
        n.template = function(e, t) {
            ...
            var r = {
                ...
                invokePartial: function(n, r, s) {
                    ...
                    if (null == l && t.compile && (s.partials[s.name] = t.compile(n, e.compilerOptions, t),
                ...
                program: function(e, t, n, r, i) {
                    var s = this.programs[e]
                      , o = this.fn(e);
                    return t || i || r || n ? s = h(this, e, o, t, n, r, i) : s || (s = this.programs[e] = h(this, e, o)),
                    s
                },
                data: function(e, t) {
                    for (; e && t--; )
            ...
            function s(t) {
                ...
                return e.useDepths && (o = n.depths ? t != n.depths[0] ? [t].concat(n.depths) : n.depths : [t]),
            ...
            s._setup = function(s) {
                if (s.partial)
                    ...
                    r.helpers = o,
                    e.usePartial && (r.partials = r.mergeIfNeeded(s.partials, t.partials)),
                    (e.usePartial || e.useDecorators) && (r.decorators = i.extend({}, t.decorators, s.decorators)),
                    r.hooks = {},
        ...
        var r, i = function(e) {
            ...
            return t.default = e,
            t
        }(e(155)), s = e(139), o = (r = s) && r.__esModule ? r : {
            default: r
        ...
        function h(e, t, n, r, i, s, o) {
            ...
            return (a = f(n, a, e, o, r, s)).program = t,
        ...
        function f(e, t, n, r, s, o) {
            if (e.decorator) {
                var a = {};
                t = e.decorator(t, a, n, r && r[0], s, o, r),
                i.extend(t, a)
            }
            return t
        }
    ...
    156: [function(e, t, n) {
        ...
        r.print = i.print,
        t.exports = r,
        void 0 !== e && e.extensions && (e.extensions[".handlebars"] = s,
        e.extensions[".hbs"] = s)
    }
    , {
        115: 115,
        ...
        (function(e) {
            (function() {
                !function(e) {
                    ...
                    i.prototype.token = function(e, t) {
                        ...
                        for (e = e.replace(/^ +$/gm, ""); e; )
                            ...
                            s = this.rules.code.exec(e))
                                ...
                                n = !1,
                                p = (s = s[0].match(this.rules.item)).length,
                                u = 0; u < p; u++)
                                    c = (l = s[u]).length,
                                    ~(l = l.replace(/^ *([*+-]|\d+\.) +/, "")).indexOf("\n ") && (c -= l.length,
                                    l = this.options.pedantic ? l.replace(/^ {1,4}/gm, "") : l.replace(new RegExp("^ {1," + c + "}","gm"), "")),
                                    this.options.smartLists && u !== p - 1 && (o === (a = r.bullet.exec(s[u + 1])[0]) || o.length > 1 && a.length > 1 || (e = s.slice(u + 1).join("\n") + e,
                                    u = p - 1)),
                                    i = n || /\n\n(?!\s*$)/.test(l),
                                    u !== p - 1 && (n = "\n" === l.charAt(l.length - 1),
                                    i || (i = n)),
                    ...
                    s.link = p(s.link).replace("inside", s._inside).replace("href", s._href).getRegex(),
                    s.reflink = p(s.reflink).replace("inside", s._inside).getRegex(),
                    s.normal = v({}, s),
                    ...
                    s.gfm = v({}, s.normal, {
                        ...
                        url: p(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("email", s._email).getRegex(),
                        _backpedal: /(?:[^?!.,:;*_~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_~)]+(?!$))+/,
                        del: /^~~(?=\S)([\s\S]*?\S)~~/,
                        text: p(s.text).replace("]|", "~]|").replace("|", "|https?://|ftp://|www\\.|[a-zA-Z0-9.!#$%&'*+/=?^_`{\\|}~-]+@|").getRegex()
                    }),
                    s.breaks = v({}, s.gfm, {
                        br: p(s.br).replace("{2,}", "*").getRegex(),
                        text: p(s.gfm.text).replace("{2,}", "*").getRegex()
                    }),
                    o.rules = s,
                        ...
                        for (var t, n, r, i, s = ""; e; )
                            if (i = this.rules.escape.exec(e))
                                ...
                                if (i = this.rules.tag.exec(e))
                                    ...
                                    e = e.substring(i[0].length),
                                    s += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(i[0]) : u(i[0]) : i[0];
                                    ...
                                    e = e.substring(i[0].length),
                                    s += this.renderer.codespan(u(i[2].trim(), !0));
                                    ...
                                    e = e.substring(i[0].length),
                                    s += this.renderer.text(u(this.smartypants(i[0])));
                                else if (e)
                                    throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                            } else
                    ...
                    c.prototype.parse = function(e) {
                        ...
                        this.inlineText = new o(e.links,v({}, this.options, {
                            renderer: new l
                        })),
                    ...
                    function _(e, t, n) {
                        ...
                        if (n || "function" == typeof t) {
                            n || (n = t,
                            t = null);
                            var r, s, o = (t = v({}, _.defaults, t || {})).highlight, a = 0;
                            try {
                                r = i.lex(e, t)
                            } catch (e) {
                                return n(e)
                            ...
                            for (; a < r.length; a++)
                                !function(e) {
                                    "code" !== e.type ? --s || l() : o(e.text, e.lang, (function(t, n) {
                                        return t ? l(t) : null == n || n === e.text ? --s || l() : (e.text = n,
                                        e.escaped = !0,
                                        void (--s || l()))
                                    }
                                    ))
    ...
    160: [function(e, t, n) {
        ...
        o.fromArray = function(e, t) {
            for (var n = new o, r = 0, i = e.length; r < i; r++)
                n.add(e[r], t);
            return n
        }
        ,
    ...
    161: [function(e, t, n) {
        ...
        n.decode = function(e, t, n) {
            var i, s, o, a, l = e.length, c = 0, u = 0;
            do {
                if (t >= l)
        ...
        n.search = function(e, t, r, i) {
            ...
            var s = function e(t, r, i, s, o, a) {
                var l = Math.floor((r - t) / 2) + t
                  , c = o(i, s[l], !0);
                return 0 === c ? l : c > 0 ? r - l > 1 ? e(l, r, i, s, o, a) : a == n.LEAST_UPPER_BOUND ? r < s.length ? r : -1 : l : l - t > 1 ? e(t, l, i, s, o, a) : a == n.LEAST_UPPER_BOUND ? l : t < 0 ? -1 : t
            }(-1, t.length, e, t, r, i || n.GREATEST_LOWER_BOUND);
            if (s < 0)
                return -1;
            for (; s - 1 >= 0 && 0 === r(t[s], t[s - 1], !0); )
                --s;
            return s
        }
    }
    ...
    164: [function(e, t, n) {
        ...
        i.prototype.add = function(e) {
            ...
            o = t.generatedColumn,
            a = n.generatedColumn,
            s > i || s == i && a >= o || r.compareByGeneratedPositionsInflated(t, n) <= 0 ? (this._last = e,
    ...
    166: [function(e, t, n) {
        ...
        c.fromSourceMap = function(e, t) {
            ...
            for (var l = e._mappings.toArray().slice(), h = n.__generatedMappings = [], p = n.__originalMappings = [], d = 0, f = l.length; d < f; d++) {
                ...
                g.source && (m.source = o.indexOf(g.source),
        ...
        c.prototype._parseMappings = function(e, t) {
            for (var n, i, s, l, c, h = 1, p = 0, d = 0, f = 0, g = 0, m = 0, v = e.length, _ = 0, y = {}, b = {}, x = [], w = []; _ < v; )
                if (";" === e.charAt(_))
                    h++,
                    _++,
                    p = 0;
                    ...
                    n.generatedColumn = p + s[0],
                    p = n.generatedColumn,
                    s.length > 1 && (n.source = g + s[1],
                    g += s[1],
                    n.originalLine = d + s[2],
                    d = n.originalLine,
                    n.originalLine += 1,
                    n.originalColumn = f + s[3],
                    f = n.originalColumn,
                    s.length > 4 && (n.name = m + s[4],
                    m += s[4])),
                    w.push(n),
        ...
        c.prototype.sourceContentFor = function(e, t) {
            ...
            var i, s = e;
            if (null != this.sourceRoot && (s = r.relative(this.sourceRoot, s)),
    ...
    167: [function(e, t, n) {
        ...
        a.prototype._serializeMappings = function() {
            for (var e, t, n, s, o = 0, a = 1, l = 0, c = 0, u = 0, h = 0, p = "", d = this._mappings.toArray(), f = 0, g = d.length; f < g; f++) {
                if (e = "",
    ...
    168: [function(e, t, n) {
        ...
        a.fromStringWithSourceMap = function(e, t, n) {
            ...
            return t.eachMapping((function(e) {
                if (null !== p) {
                    if (!(u < e.generatedLine)) {
                        var t = (n = o[l] || "").substr(0, e.generatedColumn - h);
                        return o[l] = n.substr(e.generatedColumn - h),
                        h = e.generatedColumn,
                        d(p, t),
                        void (p = e)
                    }
                ...
                if (h < e.generatedColumn) {
                    ...
                    o[l] = n.substr(e.generatedColumn),
                    h = e.generatedColumn
                }
                p = e
            }
            ...
            l < o.length && (p && d(p, c()),
            r.add(o.splice(l).join(""))),
            t.sources.forEach((function(e) {
                var s = t.sourceContentFor(e);
                null != s && (null != n && (e = i.join(n, e)),
        ...
        a.prototype.walk = function(e) {
            for (var t, n = 0, r = this.children.length; n < r; n++)
                (t = this.children[n])[o] ? t.walk(e) : "" !== t && e(t, {
                    source: this.source,
                    line: this.line,
                    column: this.column,
                    name: this.name
        ...
        a.prototype.toStringWithSourceMap = function(e) {
            ...
            return this.walk((function(e, r) {
                t.code += e,
                null !== r.source && null !== r.line && null !== r.column ? (s === r.source && o === r.line && a === r.column && l === r.name || n.addMapping({
                    source: r.source,
                    original: {
                        line: r.line,
                        column: r.column
        ...
        t.exports = class {
            ...
            _initialize() {
                ...
                const e = document.querySelector("[hreflang=en-US]")
                  , t = e && ("https://www.apple.com/" === e.href || null !== e.href.match(/.com\/$/im))
                  , n = null !== document.querySelector("html[lang=zh-CN]");
                t && !n ? document.documentElement.classList.toggle(this._selectors.fixedClass) : t && n && document.documentElement.classList.toggle(this._selectors.cnHpClass)
            }
            ...
            _initializeDropdownToggle() {
                this._arrowNavigation = new s(this._dropdownList,{
                    selector: "li",
                    state: "data-ac-ls-selected"
                }),
                this._dropdownWrapperKeyboard = new o(this._dropdownList.parentElement),
                ...
                this._dropdownFirstItemKeyboard = new o(this._firstFocusableMenuEl),
                this._dropdownLastItemKeyboard = new o(this._lastFocusableMenuEl),
            ...
            _handleCloseBarEvent() {
                ...
                this._gnMenuIcon && this._gnMenuIcon.removeEventListener("click", this._handleCloseBarEvent),
            ...
            _handleDropdownClickAway(e) {
                const t = this._dropdownList.parentElement
