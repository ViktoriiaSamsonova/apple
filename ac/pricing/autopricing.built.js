!function(t, e) {
        ...
        t.exports = new class {
            ...
            fetchProductInfo(t, e={}) {
                ...
                return a(t).then(a=>{
                    ...
                    return t === m ? c = s(u, e) : t === d ? c = r(u, e) : t === f ? c = n(u, e) : i = "API not supported",
                    i || c.then(t=>({
                        response: t,
                        options: o
                    }))
            ...
            handleProductInfo(t, e, i, r) {
                ...
                if (!i.error || r.dummyPrices) {
                    ...
                    e.parentElement.classList.add("has-dynamic-content")) : this.handleError(e, i, t)
                } else
                    this.handleError(e, i, t)
            }
            handleError(t, e, i) {
            ...
            fetchProductDataFromHTML(t, e) {
                return new Promise(i=>{
                    ...
                    this.fetchProductInfo(t, e).then(({response: e, options: r})=>{
                        e && (this[`${t}${o}`].forEach(i=>this.handleProductInfo(t, i, e, r)),
                        i(e.error))
                    }
                    ).catch(t=>{
                        throw t
    ...
    , function(t, e, i) {
        "use strict";
        var r, s = i(32).EventEmitterMicro, n = i(33), a = i(36);
        function o(t) {
            t = t || {},
            s.call(this),
            this.id = a.getNewID(),
